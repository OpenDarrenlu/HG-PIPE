...
// gelu
typedef ap_int   <  10 >   __gelu_cursor_t;
...
const int mlp_scalars_init [] = {
    #include "./refs/mlp_0_scalars.txt"
};
const int mlp_lnq_scalars_init [] = {
    #include "./refs/mlp_0_lnq_scalars.txt"
};
const long long mlp_lnq_lnb_m_init [] = {
    #include "./refs/mlp_0_lnq_lnb_m.txt"
};
const int mlp_lnq_lnw_m_init [] = {
    #include "./refs/mlp_0_lnq_lnw_m.txt"
};
const int mlp_lnq_rsqrt_table_init [] = {
    #include "./refs/mlp_0_lnq_rsqrt_table_m.txt"
};
const int mlp_m1_weight_init [CH][C] = {
    #include "./refs/mlp_0_matmul1_weight.txt"
};
const int mlp_m1_bias_init [CH] = {
    #include "./refs/mlp_0_matmul1_bias.txt"
};
const int mlp_gelu_scalars_init [] = {
    #include "./refs/mlp_0_geluq_scalars.txt"
};
const int mlp_gelu_table_init [] = {
    #include "./refs/mlp_0_geluq_table_m.txt"
};
const int mlp_m2_weight_init [C][CH] = {
    // #include "./refs/mlp_0_Iw2.txt"
    #include "./refs/mlp_0_matmul2_weight.txt"
};
const int mlp_m2_bias_init [C] = {
    #include "./refs/mlp_0_matmul2_bias.txt"
};

// test refs
const int x_ref[T][C] = {
    #include "./refs/mlp_0_input.txt"
};
const int y_ref[T][C] = {
    #include "./refs/mlp_0_output.txt"
};
...
const int lnq_ref[] = {
    #include "./refs/mlp_0_lnq_output.txt"
};
const int m1_ref[] = {
    #include "./refs/mlp_0_matmul1_output.txt"
};
const int gelu_ref[] = {
    #include "./refs/mlp_0_geluq_output.txt"
};
const int m2_ref[] = {
    #include "./refs/mlp_0_matmul2_output.txt"
};
