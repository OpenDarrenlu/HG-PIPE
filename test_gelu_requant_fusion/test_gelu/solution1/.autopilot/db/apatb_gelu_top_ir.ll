; ModuleID = 'F:/master_MLsys/USTC_spring/EDA/Project/HG-PIPE/test_gelu_requant_fusion/test_gelu/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_gelu_top_ir(%"class.hls::stream"* %i_stream, %"class.hls::stream"* %o_stream, i32* %scalars, i32* %table) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_gelu_top_hw(%"class.hls::stream"* %i_stream_copy, %"class.hls::stream"* %o_stream_copy, i32* %scalars_copy, i32* %table_copy)
...
declare void @apatb_gelu_top_hw(%"class.hls::stream"*, %"class.hls::stream"*, i32*, i32*)

define void @gelu_top_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, i32*, i32*) #7 {
entry:
  ...
  call void @gelu_top_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, i32* %2, i32* %3)
...
declare void @gelu_top_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, i32*, i32*)
